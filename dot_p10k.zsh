# Generated by Powerlevel10k configuration wizard on 2022-05-25 at 10:02 PDT.
...
() {
  ...
  function prompt_npm_version () {
    ...
    local -i idx=$?
    if (( idx )); then
      _p9k_cached_cmd 0 $_p9k__parent_dirs[idx]/package.json npm --version || return
    else
      (( _POWERLEVEL9K_NODE_VERSION_PROJECT_ONLY )) && return
      _p9k_cached_cmd 0 '' npm --version || return
    fi
    p10k segment -f green -i '' -t "$_p9k__ret" 
  }
